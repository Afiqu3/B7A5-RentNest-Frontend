  ...
  return (
    ...
    >
      ...
      <p className="mt-3 text-base leading-7 text-muted-foreground sm:text-lg">
        Explore a handpicked selection of premium rentals with the right balance
        of comfort, style, and location.
      </p>
    </motion.div>
  );
};

export default LatestPropertiesHeader;
