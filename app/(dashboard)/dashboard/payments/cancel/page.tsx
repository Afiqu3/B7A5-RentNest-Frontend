...
import { ArrowRight, CircleX, ClipboardList } from "lucide-react";
    ...
    <div className="flex min-h-[60vh] flex-1 items-center justify-center px-4 py-10">
      <div className="relative w-full max-w-md overflow-hidden rounded-3xl border border-border/70 bg-card/80 p-6 text-center shadow-sm backdrop-blur-sm duration-500 animate-in fade-in-0 zoom-in-95 sm:p-8">
        <div aria-hidden className="pointer-events-none absolute inset-0 -z-10">
          <div className="absolute -top-16 right-1/2 size-56 translate-x-1/2 rounded-full bg-destructive/10 blur-3xl" />
        </div>

        <div className="mx-auto flex size-16 items-center justify-center rounded-2xl bg-destructive/10 text-destructive duration-700 animate-in zoom-in-50">
        ...
        <p className="mx-auto mt-2 max-w-sm text-sm leading-6 text-muted-foreground sm:text-base">
          No charge was made. Your rental request is still waiting — you can head
          back and complete the payment whenever you&apos;re ready.
        </p>
